    ...
    <div className='bg-dark-slate text-light-gray lg:px-32 md:px-20 px-2 sticky top-0 z-50'>
        <div className=' hidden md:flex md:flex-row md:justify-between md:items-center md:py-1 lg:font-semibold '>
            <div className='flex flex-row justify-center items-center'>
                <NavLink className='text-light-gray font-bold p-3 cursor-pointer hover:text-light-gray' to='/'>Binaya Limbu</NavLink>
            </div>
            ...
            <div className='bg-leaf-green lg:py-2 rounded lg:px-6 md:px-3 md:py-1'>
                <NavLink className='text-light-gray hover:text-white duration-300 ease-in-out' to='/about'>Contact Me</NavLink>
            </div>
        ...
        <div className=' md:hidden flex flex-col p-3'>
            ...
            <div className={`rounded mt-4 ${toggle?"":"hidden"}`}>
                <NavLink className='w-1/2 bg-leaf-green px-5 py-1 rounded  text-light-gray hover:text-white duration-300 ease-in-out' to='/about'>Contact Me</NavLink>
            </div>
