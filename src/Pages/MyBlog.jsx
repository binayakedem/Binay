          ...
          {expandedPostIndex === index ? (
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div data-aos="fade-down"
                  ...
                  <p className="text-justify" data-aos="zoom-up " data-aos-duration="1000">{post.main_paragraph}</p>
                </div>
                <div>
                  <h1 className="font-semibold text-lg my-2 text-black font-mont">Background</h1>
                  <p className="text-justify">{post.second_paragraph}</p>
                </div>
            ...
            <div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-5">
                <div>
                  <p className="text-justify" data-aos="zoom-in-up " data-aos-duration="1200">{post.main_paragraph} ...</p>
                </div>
